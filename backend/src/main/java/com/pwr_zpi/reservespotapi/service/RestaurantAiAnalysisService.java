...
public class RestaurantAiAnalysisService {
    ...
    public AnalysisResult analyzeRestaurant(Restaurant restaurant, List<Review> reviews) {
        try {
            ...
            String systemPrompt = "You are a restaurant business analyst. Analyze the provided restaurant information and customer reviews. " +
                    ...
                    "If no reviews exist, base sentiment on description. " +
            ...
            try (HttpClient client = HttpClient.newHttpClient()) {
                ...
                if (summary.isEmpty()) {
                    summary = generateFallbackSummary(restaurant, reviews);
                }
            ...
            return new AnalysisResult(
                    generateFallbackSummary(restaurant, reviews),
                    calculateFallbackSentiment(restaurant, reviews)
            );
        }
    }

    private String generateFallbackSummary(Restaurant restaurant, List<Review> reviews) {
